...
@module @ember/array
*/
import { get, objectAt, alias, PROPERTY_DID_CHANGE, addArrayObserver, removeArrayObserver, replace, getChainTagsForKey, tagForProperty, arrayContentDidChange, arrayContentWillChange } from '@ember/-internals/metal';
...
export default class ArrayProxy extends EmberObject {
  init() {
    ...
    */
    ...
    update(tagForProperty(this, 'length'), combine(getChainTagsForKey(this, 'arrangedContent.length')));
  }
